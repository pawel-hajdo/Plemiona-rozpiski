...
import { getPlayerCommandsAdmin, getPlayersWithCommandsAdmin, getVillageCommandsAdmin, shiftCommandTimes} from "@/lib/api";
import {AdminCommand, ColumnNames, Command, Player} from "@/lib/types";
...
export default function PlayerCommandsPage({ params }: PageProps) {
    ...
    useEffect(() => {
        const fetchPlayers = async () => {
            const data = await getPlayersWithCommandsAdmin(params.world);
            setPlayers(data);
        };
